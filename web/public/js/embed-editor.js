...
async function sendEmbed() {
  ...
  // Отправляем только обычное сообщение с описанием, которое содержит правила
  
  // Блоки правил НЕ отправляются отдельно - они уже в описании
  // Правила добавляются в описание через renderRulesBlocks() и отправляются как обычное сообщение
  
  // Обычная отправка embed (правила уже в описании)
